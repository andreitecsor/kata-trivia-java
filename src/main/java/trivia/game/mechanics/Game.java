...
public class Game implements IGame {
    ...
    public void roll(int roll) {
        ...
        if (inPenaltyBox[currentPlayer]) {
            if (roll % 2 != 0) {
                ...
                if (places[currentPlayer] > 12) //changed 11 into 12, because the locations start from 1
    ...
    //Category index starts at 0, but the location starts at 1
    private String currentCategory() {
        ...
        if (places[currentPlayer] == 3) return "Sports";
        if (places[currentPlayer] == 7) return "Sports";
        if (places[currentPlayer] == 11) return "Sports";
        return "Rock";
    }
